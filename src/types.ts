...
export interface GeneratorState {
  ...
  x: number;
  z: number;
  isTargetGen: boolean; // 7 out of 10 need repair
...
export const SURVIVORS: CharacterInfo[] = [
  {
    ...
    appearance: '【面部】亞洲男性，雙眼血絲、極深黑眼圈、神情驚恐麻木，臉頰凹陷、嘴唇乾裂、額頭有揉捏紅壓痕。\n【髮型】凌亂黑髮，油膩瀏海垂在額前。\n【服裝】皺巴巴深藍色全套西裝，沾滿墨漬灰燼，領口扯開，歪斜領帶沾染咖啡漬。\n【配件】停在「深夜 23:45」的機械手錶，斜背塞滿過期文件與發票的磨損公事包。',
    personality: '極度焦慮、疲憊不堪、對權威本能恐懼，但在絕境中展現頑強「社畜韌性」——連地獄般的公司都熬得過，這場惡夢也能咬牙撐過去。奔跑時姿勢笨拙駝背，雙手死死護著公事包。',
    backstory: '佐藤健人在一家跨國企業擔任螺絲釘般的基層主管，無止境的加班、上司的苛責和龐大的房貸壓力讓他早已形同枯槁。某天深夜，他在公司大樓準備搭乘深夜電梯返家時，電梯門打開卻沒有迎來熟悉的地下停車場，而是一片濃霧與血腥味的詭異荒蕪世界。起初，他以為這只是另一場過勞引起的噩夢，直到冰冷的追殺聲在耳邊響起，他才意識到——這場加班，永遠不會有打卡下班的一刻。',
    skillName: '恐懼應激 / 社畜絕境爆發 (Panic Work Surge)',
    skillKey: 'Shift 鍵 (僅在恐懼尖叫狀態下可觸發)',
    skillDescription: '當佐藤健人發生「因恐懼而尖叫」的狀況時，按下 Shift 鍵可將極度恐慌轉化為專注，使修理電箱速度增加 10%（持續 20 秒，冷卻 15 秒）。若無因恐懼尖叫狀況無法使用 Shift 鍵（按了無反應），且嚴格禁止主動按 Shift 自行觸發尖叫。',
    modelStyle: {
      bodyColor: 0x1e3a8a,
  ...
  },
  {
    ...
    appearance: '【面部特徵】白人膚色，長期日曬與風吹雨淋帶有粗糙感。右側臉頰上有一條由刺刀或彈片劃開的明顯舊傷疤，眼神銳利且充滿戒備。\n【髮型與髮色】經典的美軍短寸頭，金色的頭髮在塵土與血污中顯得有些黯淡。\n【服裝與配色】主色調為橄欖褐色（Olive Drab）與卡其色（Khaki）。身穿破損且沾滿泥巴的 M41 野戰夾克，內搭卡其色羊毛衫。袖口和褲管紮在軍靴內，腰間繫著帶有彈藥袋與刺刀鞘的帆布腰帶。衣服多處有因爆炸或掙扎造成的焦黑與撕裂痕跡，散發濃厚的美式寫實軍事恐怖氛圍。',
    personality: '【核心特質】剛毅、勇猛、極度務實、臨危不亂。\n【背景心理】經歷過血腥的諾曼第或太平洋島嶼戰役，見證過同袍的死亡。這讓他對「生存」有著超乎常人的執著，但也背負著戰場創傷後遺症（PTSD）。在面對超自然或非理性的恐怖時，他起初會試圖用軍事戰術去理解與對抗，隨後才會意識到傳統武器的無力。',
    backstory: '1944 年秋天，傑克所屬的步兵連在法國某處陰森的密林中執行夜間偵察任務。隨著濃重的血色霧氣漫山遍野地湧來，通訊設備徹底失效，四周響起了非人的低語與沉重而詭異的腳步聲。在隨後的混戰中，德軍的防線早已不重要，因為黑暗中爬出的是遠比戰爭更為恐怖、無法用子彈殺死的扭曲怪物。傑克的同袍一個接一個在迷霧中被拖走，而他在拼死反擊、用刺刀劃破某個怪物的軀體後，逃進了一處深不見底的迷霧裂隙中。當他再次醒來時，戰場的槍砲聲已然消失，取而代之的是永無止境的詭異廢墟與那令人窒息的追逐夢魘。',
    skillName: '戰術強韌 / 戰地救援與修復 (Battlefield Grit & Repair)',
    skillKey: 'Shift 鍵 (受傷或從監獄獲救後觸發)',
    skillDescription: '當這角色在受傷狀況或從監獄獲救後，按下 Shift 鍵增加治療隊友及修機速度 10%，時間為 30 秒（冷卻 15 秒）。若無達成受傷狀況或從監獄獲救的條件則 Shift 鍵無法使用（按了無反應）。',
    modelStyle: {
      bodyColor: 0x15803d,
  ...
  },
  {
    ...
    title: '古代維京狂戰士 (Úlfhéðnar Viking Berserker)',
    faction: 'survivor',
    avatarColor: '#f97316',
    nationality: '11 世紀中葉古斯堪地那維亞人（瑞典維京人）',
    heightWeight: '185 公分，90 公斤（精壯、充滿爆發力的戰士體格，長期在極地與航海中鍛鍊出的紮實肌肉）',
    career: '西元 11 世紀中葉的古代維京狂戰士（Úlfhéðnar 信仰背景）。',
    appearance: '【膚色與臉部】長期受北歐海風與烈日摧殘的白皙皮膚，但在顴骨和鼻樑處有明顯的日曬紅暈與密集的淡褐色雀斑。\n【髮色與毛髮】如野火般耀眼的深紅色亂髮與編起短辮的落腮鬍，沾著微乾的血漬與泥土。\n【服裝點綴】身穿粗糙耐磨的褐色亞麻長袖上衣，搭配寬鬆的羊毛寬褲，繫著一條磨損嚴重的皮革腰帶，上面掛著空無一物的劍鞘與幾個殘破的護身符皮袋。',
    personality: '生性勇猛好戰、固執且極度具有戒心。面對超自然恐怖時，最初會試圖用凡人的武力與戰吼去對抗，但在見證無法理解的詭異力量後，內心深處正逐漸被恐懼與絕望侵蝕。',
    ...
    skillDescription: '被殺手攻擊到受傷時，按下 Shift 鍵移動速度 * 1.5 倍短暫提升 20 秒，之後要被重新治療（恢復健康狀態）才可再次使用技能，若無達成上述條件則 Shift 鍵無法使用（按了無反應）。',
    modelStyle: {
      bodyColor: 0xc2410c,
  ...
  },
  {
    ...
    appearance: '【臉頰與膚色】深棕色，帶有風沙吹拂與長期熬夜的粗糙質感；\n【頭髮】全黑色、凌亂且帶有油光的短髮；\n【服裝點綴】外罩一件中東傳統的黑白相間傳統長袍（Keffiyeh風格融合日常戰術服飾），長袍邊緣沾滿塵土、乾涸的血跡與撕裂的破口，在黑暗中能形成獨特的視覺剪影；\n【細節表現】眼神閃爍多疑、驚恐中帶著算計的冷酷。走路習慣壓低身形、貼牆而行；受傷時發出壓抑的喘息聲，但眼神仍死死盯著周遭的人。',
    personality: '冷酷殘酷、自私自利的極致求生哲學。「為達目的不擇手段」，在他眼中，其他的逃生者不是並肩作戰的夥伴，而是隨時可以犧牲的誘餌與擋箭牌。',
    backstory: '表面上，塔里克是一名流亡海外、尋求庇護的南非籍移工；實際上，他曾是極端組織 ISIS 內部負責敵後滲透與情報刺探的狡詐潛伏者。他在無數次殘酷的生存與追殺中磨練出極其冷血的求生本能。\n\n當他被捲入這個超自然的恐怖異空間時，他那套「為達目的不擇手段」的生存哲學並未改變——在他眼中，其他的逃生者不是並肩作戰的夥伴，而是隨時可以犧牲的誘餌與擋箭牌。',
    skillName: '背叛之影 (Shadow of Betrayal)',
    skillKey: 'Shift 鍵 (雙人被追逐時解鎖)',
    skillDescription: '當你與另一名逃生者同時被殺手追逐時解鎖：按下 Shift 鍵消失自己的氣場及足跡 10 秒，並讓被牽連隊友的足跡與氣場更明顯 10 秒（成為誘餌替死鬼），同時塔里克自身獲得額外移動速度加成 5 秒。只有在同時被追逐時才可觸發。冷卻時間 15 秒。',
    modelStyle: {
      bodyColor: 0x6b21a8,
